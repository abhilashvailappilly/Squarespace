  ...
  return (
    <div className="w-full h-3/4  flex hover:border-4 hover:border-blue-600  ">
      ...
      <div className='flex flex-col justify-center items-center'>
       <h1 className='text-3xl lg:text-4xl font-semibold ' style={{color:buttonColor}}>More about <br/> our brand</h1>
       <span style={{color:fontColor}}>Tell People about who your are, your origin, your process,or your inspirations. Tap into your creativity.You've got this. The way you tell your story online can make all the difference.</span>
      </div>
      <div>
        <button className='rounded-lg mt-10  w-28 h-10 text-white text-xs'  style={{background:buttonColor , color:fontColor}}>LEARN MORE</button>
      </div>
      
      </div>

    {/* <div className="w-full h-1/6  flex justify-center items-center">
      <button className="bg-black text-white text-xs w-24 h-2/3 rounded-2xl">SHOP ALL</button>
    </div> */}
